...
SRC_URI="https://github.com/HaxeFoundation/haxe/archive/3.4.2.tar.gz -> ${P}.tar.gz"
S="${WORKDIR}/haxe-3.4.2"
...
GIT_BRANCH="3.4.2"
GIT_COMMIT_SHA="890f8c7"
GIT_COMMIT_TIMESTAMP="1490018213"

# Submodule tarballs corresponding to the 3.4.2 release
